...
<template>
  <view class="">
    <view class="bg-#003DA5 pl-32rpx pr-32rpx pb-16rpx flex w-750rpx box-border">
      <view class="mr-32rpx">
    ...
    <z-paging ref="paging" refresher-only @onRefresh="onRefresh" :use-page-scroll="true">
      ...
      >
        <view
          class="bg-#003DA5 text-white text-28rpx mr-24rpx ml-24rpx text-center rounded-b-32rpx pt-8rpx pb-8rpx"
        >
          您好，尊贵的会员
        </view>
        <view
        ...
        >
          <view class="flex flex-col items-center">
            <view class="text-48rpx text-#003DA5 font-bold">{{ comboSpareNumTotal }}</view>
      ...
      <view v-if="!isCusShop" class="flex justify-between items-center ml-24rpx mr-24rpx">
        ...
        <view
          class="w-223rpx bg-#003DA5 h-140rpx rounded-16rpx flex flex-col justify-center items-center"
